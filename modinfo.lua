...
Ctrl + Z: undo the last batch within 5 seconds
...
Ctrl + Z: deshacer el último lote durante 5 segundos
...
Ctrl + Z: отменить последнюю посадку в течение 5 секунд
...
Ctrl + Z : annuler le dernier lot dans les 5 secondes
...
Strg + Z: letzte Pflanzung innerhalb von 5 Sekunden rückgängig machen
